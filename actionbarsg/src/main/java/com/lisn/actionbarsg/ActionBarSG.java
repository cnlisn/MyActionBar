 ...
 * @date 2019/10/24
 */
public class ActionBarSG extends FrameLayout {
    ...
    public ActionBarSG(Context context) {
        this(context, null);
    }

    public ActionBarSG(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ActionBarSG(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initAttrs(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ActionBarSG);
        ...
        mAutoImmersion = typedArray.getBoolean(R.styleable.ActionBarSG_ab_autoImmersion, true);
        mBackgroundLayerLayoutRes = typedArray.getResourceId(R.styleable.ActionBarSG_ab_backgroundLayerLayout, 0);
        mBackgroundLayerImageRes = typedArray.getResourceId(R.styleable.ActionBarSG_ab_backgroundLayerImageRes, 0);
        mStatusBarVisible = typedArray.getBoolean(R.styleable.ActionBarSG_ab_statusBarVisible, true);
        mStatusBarDarkMode = typedArray.getInt(R.styleable.ActionBarSG_ab_statusBarMode, STATUS_BAR_MODE_LIGHT) == STATUS_BAR_MODE_DARK;
        mStatusBarColor = typedArray.getColor(R.styleable.ActionBarSG_ab_statusBarColor, statusBarColorDef);
        mTitleBarLayoutRes = typedArray.getResourceId(R.styleable.ActionBarSG_ab_titleBarLayout, 0);
        mTitleBarHeight = (int) typedArray.getDimension(R.styleable.ActionBarSG_ab_titleBarHeight, titleBarHeightDef);
        mBottomLineHeight = (int) typedArray.getDimension(R.styleable.ActionBarSG_ab_bottomLineHeight, bottomLineHeightDef);
        mBottomLineColor = typedArray.getColor(R.styleable.ActionBarSG_ab_bottomLineColor, bottomLineColorDef);
        mBottomLineResId = typedArray.getResourceId(R.styleable.ActionBarSG_ab_bottomLineResId, 0);
        mBottomLineOutside = typedArray.getBoolean(R.styleable.ActionBarSG_ab_bottomLineOutside, false);
        mForegroundLayerLayoutRes = typedArray.getResourceId(R.styleable.ActionBarSG_ab_foregroundLayerLayout, 0);
        mClickToFinishViewId = typedArray.getResourceId(R.styleable.ActionBarSG_ab_clickToFinish, 0);
